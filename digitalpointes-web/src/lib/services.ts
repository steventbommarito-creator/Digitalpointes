...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: "Enriched consumer records built to improve targeting precision, match rates, and campaign performance across modern platforms — digital, mobile, CRM, and direct mail.",
